...
(function ($) {
    $(function () {
        ...
        $('.faq-link').on('click', function (e) {
            ...
            var accordionContent = $(this).parents('.faq').find('.collapse');
            if (accordionContent.hasClass('opened')) {
                $(this).parents('.faq').find('.collapse').removeClass('opened').stop().slideUp(250);
            }
            else {
                $(this).parents('.accordion').find('.collapse').removeClass('opened').stop().slideUp(250);
                accordionContent.addClass('opened').stop().slideDown(250);
            }
        });
